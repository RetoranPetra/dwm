...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_white, col_slate_blue,  col_grey_blue },
	[SchemeHid]  = { col_pickle_blue,  col_black, col_black  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb",col_black, "-nf", col_white, "-sb", col_slate_blue, "-sf", col_white, NULL };
